...
![GitHub last commit](https://img.shields.io/github/last-commit/your-user/web-portfolio)
![visitors](https://visitor-badge.laobi.icu/badge?page_id=your-user.web-portfolio.id)
...
Visit the portfolio at your deployed portfolio URL.
...
```bash
git clone https://github.com/Civalski/web-portfolio.git
cd web-portfolio
```
